  ...
  return (
    <>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        {/* Header */}
        <header style={{ padding: "20px 24px", borderBottom: "1px solid rgba(139, 92, 246, 0.15)" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ fontSize: 24, fontWeight: 900, background: "linear-gradient(135deg, #a78bfa, #c084fc)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
              ProofMap
            </div>
            <a
        ...
        <footer style={{
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <p style={{ fontSize: 14, color: "rgba(230, 238, 248, 0.5)", marginBottom: 16 }}>
            ...
            >
              ...
              View on GitHub — open source &amp; self-hostable
            </a>
          </div>
        </footer>
      </div>
